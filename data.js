module.exports = [
  {
    id: "burger",
    img_url: "/assets/burger.png",
    title: 'Triplo bacon burger',
    discription: 'Jorge Relato',
    ingredients: [
  ...
  {
    id: "asinha",
    img_url: "/assets/asinha.png",
    title: 'Asinhas de frango ao barbecue',
    discription: 'Vania Steroski',
    ingredients: [
  ...
  {
    id: "lasanha",
    img_url: "/assets/lasanha.png",
    title: "Lasanha mac n' cheese",
    discription: 'Juliano Vieira',
    ingredients: [
  ...
  {
    id: "espaguete",
    img_url: "/assets/espaguete.png",
    title: 'Espaguete ao alho',
    discription: 'Júlia Kinoto',
    ingredients: [
  ...
  {
    id: "doce",
    img_url: "/assets/doce.png",
    title: 'Docinhos pão-do-céu',
    discription: 'Ricardo Golvea',
    ingredients: [
      '1 kg de batata - doce',
      '100 g de manteiga',
      '3 ovos',
